...
public class Articulo {
	 ...
	 */
	public Articulo(int codigo, String descripcion, float precioCompra, float precioVenta, int stock, String departamento) {
		if (codigo >= 0)
			this.codigo = codigo;
		...
		this.dept = Departamento.valueOf(departamento.toUpperCase());
	}
	...
	public String toString() {
		...
		articulo += "Departamento: " + this.dept + "\n";
